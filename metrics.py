...
COMMITMENT_CURRENT_EPOCH_SUBMITTED_PROOFS = Gauge("fluence_network_cc_current_epoch_submitted_proofs", "Current epoch actual proofs", ['cc_id','provider_id','provider_name'], registry=registry)
